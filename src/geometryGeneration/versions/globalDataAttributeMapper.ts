...
export const globalDataAttributeMapper: Record<VersionParameterNames, string> = {
  ...
  [VersionParameterNames.shapePreProcessing]: 'preProcessing',
  [VersionParameterNames.shapePreProcessingprocessingMethodType]: 'type',
  [VersionParameterNames.shapePreProcessingWarp]: 'warp',
  [VersionParameterNames.shapePreProcessingWarpabsolute]: 'absolute',
  [VersionParameterNames.shapePreProcessingWarpprocessingMethodType]: 'type',
  [VersionParameterNames.shapePreProcessingWarptotal]: 'total',
  [VersionParameterNames.shapePreProcessingWarplinearTwist]: 'angle',
  [VersionParameterNames.shapePreProcessingWarpmaxAmplitude]: 'max',
  [VersionParameterNames.shapePreProcessingWarpminAmplitude]: 'min',
  [VersionParameterNames.shapePreProcessingWarpperiod]: 'period',
  [VersionParameterNames.shapePreProcessingWarpphaseShift]: 'phaseShift',
  [VersionParameterNames.shapePreProcessingTwist]: 'twist',
  [VersionParameterNames.shapePreProcessingTwistabsolute]: 'absolute',
  [VersionParameterNames.shapePreProcessingTwistprocessingMethodType]: 'type',
  [VersionParameterNames.shapePreProcessingTwisttotal]: 'total',
  [VersionParameterNames.shapePreProcessingTwistlinearTwist]: 'angle',
  [VersionParameterNames.shapePreProcessingTwistmaxAmplitude]: 'max',
  [VersionParameterNames.shapePreProcessingTwistminAmplitude]: 'min',
  [VersionParameterNames.shapePreProcessingTwistperiod]: 'period',
  [VersionParameterNames.shapePreProcessingTwistphaseShift]: 'phaseShift',
};
